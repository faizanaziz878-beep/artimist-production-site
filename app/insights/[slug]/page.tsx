...
const articleVisuals: Record<string, { src: string; alt: string; caption: string }[]> = {
  ...
  "do-house-plans-need-an-architect-stamp": [
    { src: "/img/permit01.webp", alt: "Residential permit drawing sheet", caption: "The reviewing authority determines which drawings and professional seals are required." },
    { src: "/media/projects/permit-sets.webp", alt: "Coordinated residential permit drawing package", caption: "Responsibilities should be agreed before the submission package is produced." },
  ],
  "what-drawings-are-needed-for-a-home-addition-permit": [
    { src: "/img/permit04.webp", alt: "Home addition permit drawing package", caption: "Existing and proposed information makes the scope of work clear." },
    { src: "/img/resext01.webp", alt: "Residential addition exterior design", caption: "Plans, elevations and sections must describe how the addition joins the existing home." },
  ],
  "how-to-turn-a-hand-sketch-into-floor-plans": [
    { src: "/media/technical/board-16.webp", alt: "Hand sketch developed into architectural floor plans", caption: "The first task is separating design intent from verified measurements." },

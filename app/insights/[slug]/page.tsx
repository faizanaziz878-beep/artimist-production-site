...
const articles: Record<string, Article> = {
  ...
  "do-house-plans-need-an-architect-stamp": {
    title: "Do House Plans Need an Architect's Stamp?",
    description: "Learn when U.S. house plans may need an architect's stamp, why requirements vary by jurisdiction and what to verify before ordering permit drawings.",
    intro: "Sometimes—but there is no single nationwide rule that answers every residential project. In the United States, stamping and sealing requirements can depend on the state, local permitting authority, building type, project size, construction method and whether structural or other regulated design work is involved.",
    sections: [
      { heading: "Start with the authority having jurisdiction", body: ["The city, county or other permitting authority reviewing the project is the best starting point. Ask what drawings are required, which disciplines must prepare or seal them and whether any residential exemptions apply to the proposed work.", "Do not assume that a plan accepted for one property will be accepted in another location. Local amendments, zoning conditions, climate requirements and departmental procedures can change the submission."] },
      { heading: "A drafting service and a licensed professional have different roles", body: ["A remote studio can help develop design information and produce coordinated drawings, but it should not imply that its work replaces a locally required architect, engineer or other licensed professional.", "If a seal is required, identify the professional early. They may need to control, review or revise the work under the rules that govern their practice, rather than simply stamp a completed outside package."] },
      { heading: "Structural and specialist information may be separate", body: ["Even when the architectural portion of a small residential project does not require an architect's seal, structural calculations or drawings may require an engineer. Energy, mechanical, septic, civil, fire or other information may also come from separate specialists.", "The permit checklist should therefore be treated as a coordinated list of responsibilities, not only a list of drawing sheets."] },
      { heading: "What to confirm before commissioning plans", body: ["Record the project address, scope, applicable permit office, required sheets, required professional seals and submission format. Share written guidance from the authority with the design team before the fee and schedule are finalized.", "This early check protects the homeowner from buying a drawing package that is attractive but incomplete for the intended approval pathway."] },
    ],
    takeaways: ["There is no universal U.S. answer for every house project.", "Confirm requirements with the local permitting authority.", "Identify required licensed professionals before production begins.", "Treat structural and specialist documents as explicit responsibilities."],
    serviceHref: "/residential-renovation-permit-drawings", serviceLabel: "Homeowner permit drawing support"
  },
  "what-drawings-are-needed-for-a-home-addition-permit": {
    title: "What Drawings Are Needed for a Home Addition Permit?",
    description: "A practical overview of drawings commonly requested for a U.S. home addition permit and the local checks homeowners should complete first.",
    intro: "A home addition permit package commonly explains the existing property, the proposed work and how the addition relates to the house, site and applicable requirements. The exact checklist is set by the reviewing authority, so this guide is a planning aid—not a substitute for its current instructions.",
    sections: [
      { heading: "Existing-condition and site information", body: ["The package may begin with a site plan showing property boundaries, setbacks, the existing building and the proposed addition. Existing floor plans and exterior elevations help reviewers understand what changes and what remains.", "Reliable measurements, a survey where required and clear photographs reduce uncertainty. Information should not be invented when the existing building has not been verified."] },
      { heading: "Proposed plans, elevations and sections", body: ["A proposed floor plan normally identifies rooms, dimensions, doors, windows, stairs, fixtures and the relationship between old and new construction. Exterior elevations show height, openings, roof form and materials. Building sections explain vertical relationships and key assemblies.", "Depending on the scope, roof plans, reflected ceiling information, schedules and enlarged details may also be requested."] },
      { heading: "Structure, energy and building systems", body: ["Foundations, beams, headers, framing and connections often require structural information. The authority may also request energy-code documentation, mechanical or electrical layouts, plumbing information or other specialist submissions.", "Confirm which items must be designed or sealed by locally licensed professionals before defining the drawing scope."] },
      { heading: "Build the permit checklist before the drawing list", body: ["Contact the permit office, locate its current residential-addition checklist and note zoning or planning reviews that occur before building review. Then assign responsibility for every item between the homeowner, surveyor, designer, architect, engineer, contractor and other consultants.", "A clear responsibility matrix is more useful than assuming one provider supplies every permit document."] },
    ],
    takeaways: ["Use the current checklist from the reviewing authority.", "Document both existing conditions and proposed work.", "Plan for structural and specialist requirements separately.", "Assign responsibility for every submission item."],
    serviceHref: "/home-addition-plans", serviceLabel: "Home addition plans"
  },
  "how-to-turn-a-hand-sketch-into-floor-plans": {
    title: "How to Turn a Hand Sketch Into Floor Plans",
    description: "Learn what dimensions, photos and notes help a designer convert a hand sketch into an accurate architectural floor plan.",
    intro: "A hand sketch is a useful way to communicate room relationships and priorities, but it is not automatically a measurable plan. Converting it into a reliable floor plan means separating design intent from verified information, resolving missing dimensions and agreeing on what the finished drawing will be used for.",
    sections: [
      { heading: "Label intent and known dimensions", body: ["Name each room, mark doors and windows, note fixed features and add every trustworthy dimension. If the sketch is for an existing building, distinguish measured dimensions from estimates. If it is a new design, include an intended overall size or target area.", "Simple notes about views, sunlight, privacy, accessibility, furniture and circulation often explain more than a polished sketch without priorities."] },
      { heading: "Provide supporting property information", body: ["For existing spaces, send clear photographs, ceiling heights, wall thicknesses where known and any existing plans or survey material. For a new house, provide site dimensions, orientation, access, setbacks or other known constraints.", "The designer should flag conflicts and missing information rather than silently guessing critical geometry."] },
      { heading: "Choose the required level of output", body: ["A clean presentation floor plan, a design-development plan and a permit or construction set are different deliverables. Decide whether you need only a redrawn concept, layout options, dimensions, furniture, elevations, sections, a 3D model or approval support.", "Defining the next use of the plan prevents unnecessary work and makes quotes easier to compare."] },
      { heading: "Review the first draft systematically", body: ["Check overall dimensions, room sizes, door swings, window positions, circulation and furniture before focusing on graphic style. Mark changes on one coordinated review rather than sending conflicting comments across many messages.", "For work that will be built, important site and existing-condition dimensions must be verified and the package coordinated with applicable professionals and local requirements."] },
    ],
    takeaways: ["Mark measured information separately from estimates.", "Send photos, constraints and intended use with the sketch.", "Define whether the output is concept, design or documentation.", "Verify critical dimensions before construction decisions."],
    serviceHref: "/sketch-to-floor-plan-service", serviceLabel: "Sketch to floor plan service"
  },
  "what-to-send-for-a-3d-home-rendering": {
    title: "What to Send for a 3D Home Rendering",
    description: "A concise brief checklist for house exterior and interior rendering, including plans, elevations, materials, references, views and deadlines.",
    intro: "The best rendering brief reduces guesswork without preventing creative input. A visualization studio needs enough information to understand the geometry, intended materials, important views and current design status before it can quote accurately or produce images that support real decisions.",
    sections: [
      { heading: "Send the most current design information", body: ["Share floor plans, elevations, sections and any available 3D model. Identify the correct revision and tell the studio which parts remain unresolved. If only a sketch or floor plan exists, state whether the quote should include architectural modeling or design development.", "Native files can speed setup, but PDFs remain useful references for dimensions, notes and drawing status."] },
      { heading: "Define materials, landscape and furnishing direction", body: ["Provide finish selections where they exist and references where they do not. For exteriors, include site context, grading, planting, paving and neighboring conditions that matter. For interiors, include furniture, fixtures, lighting and styling direction.", "Label inspiration images by what should be borrowed—material, mood, camera, lighting or furniture—rather than expecting the studio to guess."] },
      { heading: "Specify views and image use", body: ["A rough camera markup or list of spaces helps define image count. Explain whether the renderings are for design review, homeowner decisions, planning, real-estate marketing, a website, print or animation, because output size and polish can differ.", "If the studio should recommend cameras, say so and define how many options will be reviewed before final production."] },
      { heading: "Set milestones, revisions and handover", body: ["Include the deadline, review contacts and any fixed presentation date. A controlled workflow normally approves geometry and cameras before final materials, lighting and post-production.", "Confirm included revision rounds, final resolution, file formats and whether the 3D scene or editable source files are part of the handover."] },
    ],
    takeaways: ["Send current drawings and clearly identify unresolved design areas.", "Explain what each visual reference is meant to communicate.", "Define image count, use, resolution and deadline.", "Agree on review stages and source-file handover."],
    serviceHref: "/floor-plan-to-3d-rendering", serviceLabel: "Floor plan to 3D rendering"
  },
};
...
const articleVisuals: Record<string, { src: string; alt: string; caption: string }[]> = {
  "how-much-do-custom-house-plans-cost": [
    ...
    { src: "/media/generated-architecture/artimist-architecture-035.webp", alt: "Completed compact courtyard house exterior", caption: "The final visual package connects plan decisions to a believable architectural outcome." },
  ],
  "permit-drawings-vs-construction-drawings": [
    ...
    { src: "/media/generated-architecture/artimist-architecture-022.webp", alt: "Accessibility construction details and dimensions", caption: "Enlarged details carry the dimensions and assembly information needed beyond approval." },
  ],
  "how-to-modify-an-existing-floor-plan": [
    ...
    { src: "/media/generated-architecture/artimist-architecture-046.webp", alt: "Courtyard house design evolution diagram", caption: "Massing, floor layouts and finishes reveal the design in successive stages." },
    { src: "/img/cad03.webp", alt: "Dimensioned residential ground-floor drawing", caption: "A dimensioned plan coordinates room relationships, openings and circulation." },
  ],
  "revit-drafting-vs-cad-drafting": [
    ...
    { src: "/media/editorial/bim-coordination-study.jpg", alt: "Coordinated BIM model and architectural documentation study", caption: "Model-based coordination becomes valuable when several drawings must stay synchronized." },
  ],
  "what-is-scan-to-bim": [
    { src: "/media/editorial/bim-coordination-study.jpg", alt: "Existing building information translated into a coordinated BIM model", caption: "Measured survey information becomes structured, coordinated building data." },
    { src: "/media/generated-architecture/artimist-architecture-088.webp", alt: "Measured section through an existing townhouse", caption: "The model must remain traceable to the surveyed existing geometry." },
  ...
  "3d-rendering-vs-unreal-engine-walkthrough": [
    ...
    { src: "/img/ue04.webp", alt: "Real-time architectural environment inside the Unreal Engine workspace", caption: "Real-time environments trade a fixed camera for interactive spatial exploration." },
  ],
  "do-house-plans-need-an-architect-stamp": [
    { src: "/img/cad03.webp", alt: "Residential floor plan drawing", caption: "The reviewing authority determines which drawings and professional seals are required." },
    { src: "/media/generated-architecture/artimist-architecture-012.webp", alt: "Backyard studio drawing package concept study", caption: "Responsibilities should be agreed before the submission package is produced." },
  ],
  "what-drawings-are-needed-for-a-home-addition-permit": [
    { src: "/media/generated-architecture/artimist-architecture-088.webp", alt: "Townhouse rear extension section concept", caption: "Illustrative section: show how the extension connects with the existing home." },
    { src: "/img/resext01.webp", alt: "Residential exterior design visualization", caption: "Plans, elevations and sections must describe how the addition joins the existing home." },
  ],
  "how-to-turn-a-hand-sketch-into-floor-plans": [
    { src: "/media/generated-architecture/artimist-architecture-043.webp", alt: "Pencil-style townhouse plan concept", caption: "Illustrative sketch plan: separate design intent from verified site measurements." },
    { src: "/media/generated-architecture/artimist-architecture-053.webp", alt: "Existing and proposed architectural floor plans", caption: "A coordinated review turns rough intent into an inspectable plan." },
  ],
  "what-to-send-for-a-3d-home-rendering": [
    { src: "/img/resext03.webp", alt: "Photoreal house exterior rendering", caption: "Clear geometry, materials and camera direction create a more reliable visualization brief." },
    { src: "/img/homeint03.webp", alt: "Photoreal home interior rendering", caption: "Interior references should identify the intended finishes, furniture, lighting and atmosphere." },
  ],
};

const CSS = `.article{min-height:100vh;background:#090809;color:#eee8e3;padding:100px 0 130px;font-family:Arial,Helvetica,sans-serif;line-height:1.75}.article *{box-sizing:border-box}.article a{color:inherit}.article-wrap{width:min(1120px,calc(100% - 40px));margin:auto}.article-crumb{font-size:12px;color:#998f89;margin-bottom:44px}.article-crumb a{text-decoration:none}.article-kicker{font-size:11px;letter-spacing:.2em;text-transform:uppercase;color:#d45e73;font-weight:700}.article h1,.article h2{font-family:Georgia,'Times New Roman',serif;font-weight:400}.article h1{font-size:clamp(46px,7vw,82px);line-height:.98;letter-spacing:-.045em;margin:16px 0 24px;max-width:980px}.article-lead{font-size:20px;color:#c3b7b0;max-width:76ch;margin:0 0 46px}.article-visual{margin:0 0 58px;overflow:hidden;border:1px solid rgba(255,255,255,.1);background:#e9e2d8}.article-visual img{display:block;width:100%;height:auto;aspect-ratio:16/9;object-fit:contain}.article-visual figcaption{display:flex;justify-content:space-between;gap:20px;padding:14px 18px;background:#100e0f;color:#a99e98;font-size:12px}.article-visual figcaption span:first-child{color:#d45e73;letter-spacing:.12em;text-transform:uppercase;font-size:9px}.article-sec{padding:42px 0;border-top:1px solid rgba(255,255,255,.09);display:grid;grid-template-columns:80px 1fr;gap:20px;content-visibility:auto;contain-intrinsic-size:360px}.article-sec-index{color:#d45e73;font-size:11px;letter-spacing:.16em;padding-top:8px}.article-sec-copy{max-width:800px}.article-sec h2{font-size:36px;line-height:1.12;margin:0 0 18px}.article-sec p{font-size:17px;color:#b5aaa4;margin:0 0 16px}.article-visual-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin:18px 0 66px}.article-visual-grid .article-visual{margin:0;border-radius:0}.article-visual-grid .article-visual img{aspect-ratio:4/3}.article-visual-grid .article-visual figcaption{display:block;min-height:86px}.article-visual-grid .article-visual figcaption span{display:block;margin-bottom:6px}.article-mid-visual{margin-top:18px;margin-bottom:66px}.article-take{margin:38px 0;padding:32px;border:1px solid rgba(255,255,255,.1);background:linear-gradient(145deg,rgba(153,38,54,.16),#100e0f)}.article-take h2{margin:0 0 16px;font-size:31px}.article-take ul{margin:0;padding-left:20px;color:#c1b5af;display:grid;grid-template-columns:1fr 1fr;gap:8px 28px}.article-take li{margin:4px 0}.article-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:34px}.article-actions a{border:1px solid rgba(255,255,255,.12);padding:10px 15px;border-radius:999px;text-decoration:none;color:#c9beb8}.article-actions a:first-child{background:#992636;border-color:#992636;color:#fff}.article--scan .article-wrap{width:min(1240px,calc(100% - 40px))}.article--scan h1{max-width:1100px;font-size:clamp(58px,8vw,110px);line-height:.84}.article--scan .article-lead{max-width:70ch}.article-scan-hero{display:grid;grid-template-columns:1.25fr .75fr;gap:0;margin:0 0 60px;border:1px solid rgba(255,255,255,.14)}.article-scan-hero .article-visual{margin:0;border:0;border-right:1px solid rgba(255,255,255,.14)}.article-scan-flow{display:grid;grid-template-rows:auto repeat(5,1fr);background:#e7e2d9;color:#111214}.article-scan-flow:before{content:"SCAN → BIM / CONTROL SEQUENCE";display:block;padding:18px;border-bottom:1px solid rgba(0,0,0,.22);font-size:9px;letter-spacing:.15em;color:#8f203b}.article-scan-flow div{display:grid;grid-template-columns:52px 1fr;align-items:center;gap:12px;padding:15px 18px;border-bottom:1px solid rgba(0,0,0,.18)}.article-scan-flow div:last-child{border-bottom:0}.article-scan-flow span{color:#8f203b;font-size:10px;letter-spacing:.12em}.article-scan-flow strong{font-family:Georgia,serif;font-size:22px;font-weight:400}.article-scan-flow small{grid-column:2;color:#756d68;font-size:10px;letter-spacing:.06em;text-transform:uppercase}.article-scan-note{margin:-30px 0 54px;padding:16px 18px;border-left:3px solid #9d3043;background:rgba(157,48,67,.09);color:#b3a7a0;font-size:13px}.article-scan-hero + .article-scan-note{}@media(max-width:760px){.article-scan-hero{grid-template-columns:1fr}.article-scan-flow{grid-template-rows:none}.article{padding-top:88px}.article-wrap{width:min(100% - 28px,1040px)}.article h1{font-size:clamp(46px,14vw,66px)}.article-sec{grid-template-columns:1fr;gap:8px}.article-sec-index{padding-top:0}.article-sec h2{font-size:30px}.article-visual-grid{grid-template-columns:1fr}.article-visual{margin-bottom:44px}.article-visual figcaption{display:block}.article-visual figcaption span{display:block;margin-bottom:6px}.article-take ul{grid-template-columns:1fr}}`;
...
export default async function InsightArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const schema = {
    ...
    "@graph": [
      { "@type": "Article", "@id": `${url}#article`, headline: article.title, description: article.description, url, datePublished: "2026-08-30", dateModified: "2026-08-30", author: { "@type": "Organization", "@id": `${BASE}/#organization`, name: "Artimist Productions" }, publisher: { "@id": `${BASE}/#organization` }, mainEntityOfPage: url, inLanguage: "en-US" },
  ...
  return <main className={`article ${slug === "what-is-scan-to-bim" ? "article--scan" : ""}`}>
    <style dangerouslySetInnerHTML={{ __html: CSS }} />
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
    <article className="article-wrap">
      <nav className="article-crumb" aria-label="Breadcrumb"><Link href="/">Home</Link> / <Link href="/insights">Insights</Link> / {article.title}</nav>
      <div className="article-kicker">{slug === "what-is-scan-to-bim" ? "Measured building workflow / Technical guide" : "Practical guide / Artimist Productions"}</div>
      <h1>{article.title}</h1>
      <p className="article-lead">{article.intro}</p>
      {slug === "what-is-scan-to-bim" ? <><div className="article-scan-hero"><figure className="article-visual"><img src={visuals[0].src} alt={visuals[0].alt} width="1600" height="900" fetchPriority="high" /><figcaption><span>Measured reference → coordinated model</span>{visuals[0].caption}</figcaption></figure><div className="article-scan-flow" aria-label="Scan to BIM workflow"><div><span>01</span><strong>Capture</strong><small>Survey data</small></div><div><span>02</span><strong>Register</strong><small>Align + verify</small></div><div><span>03</span><strong>Model</strong><small>Interpret geometry</small></div><div><span>04</span><strong>Check</strong><small>Compare tolerances</small></div><div><span>05</span><strong>Deliver</strong><small>Structured BIM</small></div></div></div><p className="article-scan-note">A scan records existing surfaces. The BIM model is a deliberate interpretation built to a defined purpose, discipline and tolerance.</p></> : <figure className="article-visual"><img src={visuals[0].src} alt={visuals[0].alt} width="1600" height="900" fetchPriority="high" /><figcaption><span>Visual reference 01{visuals[0].src.includes("/generated-architecture/") ? " · Concept study" : ""}</span>{visuals[0].caption}</figcaption></figure>}
      {article.sections.map((section,index) => {
        const visual = index % 2 === 1 ? visuals[1 + Math.floor(index / 2)] : undefined;
        return <Fragment key={section.heading}><section className="article-sec"><div className="article-sec-index">0{index + 1}</div><div className="article-sec-copy"><h2>{section.heading}</h2>{section.body.map((paragraph)=><p key={paragraph}>{paragraph}</p>)}</div></section>{visual && <figure className="article-visual article-mid-visual"><img src={visual.src} alt={visual.alt} width="1600" height="900" loading="lazy" decoding="async" /><figcaption><span>Visual reference 0{2 + Math.floor(index / 2)}{visual.src.includes("/generated-architecture/") ? " · Concept study" : ""}</span>{visual.caption}</figcaption></figure>}</Fragment>;
      })}
      <section className="article-take"><h2>Key takeaways</h2><ul>{article.takeaways.map((item)=><li key={item}>{item}</li>)}</ul></section>
      <div className="article-actions"><Link href={article.serviceHref}>{article.serviceLabel}</Link><Link href="/case-studies">Case studies</Link><Link href="/international">International delivery</Link><Link href="/contact">Discuss a project</Link></div>
    </article>
  </main>;
}

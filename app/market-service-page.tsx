  ...
  return <main className="market">
    ...
    <div className="market-wrap">
      ...
      <section className="market-hero">
        ...
        <div className="market-hero-copy"><div className="market-kicker">{props.kicker}</div><h1>{props.h1}</h1><p className="market-lead">{props.intro}</p><div className="market-hero-actions"><Link className="market-btn" href="/contact">Brief the studio</Link><Link className="market-btn-quiet" href="/case-studies">See project evidence</Link></div></div>
      ...
      <section className="market-sec"><div className="market-kicker">Services</div><h2>Remote design and production support with a clear project handoff.</h2><div className="market-grid">{services.map((service, index) => <Link className="market-card" key={service.href} href={service.href}><span className="market-card-index">0{index + 1}</span><h3>{service.title}</h3><p>{service.copy}</p></Link>)}</div></section>

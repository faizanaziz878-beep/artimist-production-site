...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "Artimist Productions", locale: "en_US", url: SITE_URL, title: "Architecture, Design & 3D Visualization Studio | Artimist", description: "Architecture, interiors, BIM and Revit, rendering, animation, branding, web design and interactive experiences from one international studio.", images: [{ url: DEFAULT_SOCIAL_IMAGE, width: 1600, height: 900, alt: "Artimist Productions architecture and visualization work" }] },
  twitter: { card: "summary_large_image", title: "Architecture, Design & 3D Visualization Studio | Artimist", description: "One international studio for architecture, interiors, BIM, visualization, animation, branding, web and interactive experiences.", images: [DEFAULT_SOCIAL_IMAGE] },

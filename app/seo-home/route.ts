...
function enhance(source: string) {
  ...
  html = html.replace('</body>', `<script src="/lead-attribution.js"></script><script src="/mobile-cleanup.js"></script><script src="/whatsapp-conversations.js"></script>${menuEnhancement}</body>`);
  return html;
}

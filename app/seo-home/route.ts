...
function enhance(source: string) {
  ...
  html = html.replace('<h1>Atmosphere begins<br>before <em>the door.</em></h1>', '<h1>Architecture, Design, 3D Visualization &amp; Creative Production Studio</h1>');

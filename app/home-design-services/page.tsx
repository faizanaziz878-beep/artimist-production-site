...
.hd-intro{padding:82px 0 72px}.hd-intro-panel{position:relative;padding:44px;border:1px solid rgba(255,255,255,.1);border-radius:22px;background:linear-gradient(135deg,rgba(255,255,255,.028),rgba(163,40,64,.055));overflow:hidden}.hd-intro-panel:before{content:'';position:absolute;left:0;top:0;width:4px;height:100%;background:#a32840}.hd-intro-copy{display:grid;grid-template-columns:.9fr 1.1fr;gap:64px;align-items:end}.hd-intro h2{font-family:Georgia,'Times New Roman',serif;font-size:clamp(40px,4.2vw,58px);line-height:1.01;letter-spacing:-.04em;margin:10px 0 0;max-width:12ch;font-weight:400}.hd-intro p{font-size:16px;line-height:1.6;color:#a99e98;margin:0;max-width:520px}.hd-problem-list{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:34px}.hd-problem{position:relative;display:flex;flex-direction:column;min-height:360px;border:1px solid rgba(255,255,255,.09);border-radius:16px;background:#0d0c0d;overflow:hidden;transition:transform .3s ease,border-color .3s ease,box-shadow .3s ease}.hd-problem:hover{transform:translateY(-5px);border-color:rgba(206,109,126,.42);box-shadow:0 24px 48px rgba(0,0,0,.28)}.hd-problem-media{position:relative;height:205px;overflow:hidden;background:#111}.hd-problem-media:after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.02),rgba(0,0,0,.48))}.hd-problem-media img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .75s cubic-bezier(.2,.8,.2,1),filter .3s ease}.hd-problem:hover .hd-problem-media img{transform:scale(1.045);filter:brightness(1.05)}.hd-problem-index{position:absolute;z-index:2;left:16px;top:16px;display:flex;align-items:center;justify-content:center;width:34px;height:34px;border:1px solid rgba(255,255,255,.22);border-radius:999px;background:rgba(7,7,7,.58);backdrop-filter:blur(10px);font-size:9px;letter-spacing:.12em;color:#eee6e0}.hd-problem-body{position:relative;display:flex;flex:1;align-items:flex-end;justify-content:space-between;gap:18px;padding:20px}.hd-problem small{display:block;font-size:9px;color:#c66f80;letter-spacing:.12em;text-transform:uppercase;margin-bottom:7px}.hd-problem h3{font-family:Georgia,'Times New Roman',serif;font-size:27px;line-height:1.04;font-weight:400;margin:0}.hd-problem-arrow{flex:0 0 auto;align-self:flex-end;font-size:20px;color:#8f8580;transition:transform .25s ease,color .25s ease}.hd-problem:hover .hd-problem-arrow{transform:translate(3px,-3px);color:#f1ebe6}
...
@media(max-width:900px){.hd-hero{grid-template-columns:1fr;min-height:auto;padding-top:118px}.hd h1{max-width:10ch}.hd-media{min-height:600px}.hd-intro-copy{grid-template-columns:1fr;gap:20px;align-items:start}.hd-intro p{margin-top:0}.hd-problem-list{grid-template-columns:1fr 1fr}.hd-problem:last-child{grid-column:1/-1}.hd-problem:last-child .hd-problem-media{height:260px}.hd-services-head{grid-template-columns:1fr;gap:24px}.hd-proof{grid-template-columns:1fr}.hd-proof-media{min-height:520px}.hd-service-grid{grid-template-columns:1fr 1fr}}
@media(max-width:640px){.hd-shell{width:calc(100% - 28px)}.hd-hero{padding:102px 0 56px;gap:34px}.hd h1{font-size:clamp(48px,14vw,68px);max-width:8.7ch}.hd-lead{font-size:16px}.hd-actions .hd-btn{width:100%}.hd-mini{gap:12px;flex-wrap:wrap;font-size:9px}.hd-media{min-height:470px}.hd-main-img{inset:0 34px 0 0;border-radius:16px}.hd-float{width:150px;height:196px;bottom:26px;border-width:6px;border-radius:12px}.hd-stat{right:8px;top:16px;font-size:8px;padding:10px 12px}.hd-intro{padding:58px 0 56px}.hd-intro-panel{padding:28px 20px 20px;border-radius:16px}.hd-intro h2{font-size:clamp(38px,11vw,50px);max-width:12ch}.hd-intro p{font-size:15px}.hd-problem-list{grid-template-columns:1fr;gap:10px;margin-top:24px}.hd-problem,.hd-problem:last-child{grid-column:auto;min-height:0}.hd-problem-media,.hd-problem:last-child .hd-problem-media{height:190px}.hd-problem-body{padding:17px}.hd-problem h3{font-size:24px}.hd-transform{padding:64px 0}.hd-transform-head{display:block}.hd-transform-copy{margin-top:20px}.hd-flow{grid-template-columns:1fr}.hd-flow article{min-height:190px}.hd-flow h3{margin-top:28px}.hd-proof-wrap{padding:64px 0}.hd-proof-media{min-height:430px}.hd-proof-copy{padding:34px 24px}.hd-proof-copy h2{font-size:38px}.hd-services{padding:62px 0}.hd-service-grid{grid-template-columns:1fr}.hd-service{font-size:20px}.hd-end{padding:40px 0 95px}.hd-end-panel{padding:38px 24px;border-radius:16px}}
@media(prefers-reduced-motion:reduce){.hd-main-img img{animation:none}.hd-problem-media img{transition:none}}
`;
          ...
          <div className="hd-problem-list" aria-label="Choose what you want to change">
            {paths.map((item, index) => (
              <Link className="hd-problem" href={item.href} key={item.href}>
                <div className="hd-problem-media">
                  <img src={item.image} alt={item.title} loading="lazy" />
                  <span className="hd-problem-index">0{index + 1}</span>
                </div>
                <div className="hd-problem-body">
                  <span>

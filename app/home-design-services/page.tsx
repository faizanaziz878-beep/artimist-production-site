  ...
  return (
    <main className="hd">
      ...
      <section className="hd-shell hd-intro">
        <div className="hd-intro-grid">
          <div>
            <div className="hd-eyebrow">Start with the problem</div>
            <h2>What are you trying to change?</h2>
          </div>
          <p>
            You do not need to know the architectural terminology. Show us the room, plan, photo or idea you already have and choose the outcome you want.
          </p>
        </div>
      </section>

      <section className="hd-shell hd-paths" aria-label="Home redesign paths">
        {paths.map((item) => (
          <Link className="hd-card" href={item.href} key={item.href}>

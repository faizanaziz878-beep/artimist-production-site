  ...
  return <main className="intl">
    ...
    <div className="intl-wrap">
      ...
      <section className="intl-hero">
        ...
        <aside className="intl-hero-card"><div className="intl-globe">INTL.</div><p>One multidisciplinary production relationship, structured online reviews, native source files and a workflow that can adapt to local consultants, standards and statutory requirements.</p></aside>
      </section>
      ...
      <section className="intl-cta"><h2>Start from wherever your project is now.</h2><p>Send the plan set, model, survey, references or early brief. Artimist can define a scope that fits the stage, market and deliverables you actually need.</p><Link className="intl-btn" href="/contact">Start a project</Link></section>
    </div>
  </main>;
}

  ...
  return (
    <main className="sv-root">
      ...
      <div className="sv-wrap">
        ...
        {s.motion ? <section className="sv-motion"><div className="sv-motion-copy"><span>Motion evidence / selected sequence</span><h2>{s.motion.title}</h2></div><figure><video autoPlay muted loop playsInline preload="metadata" poster={s.motion.poster}><source src={s.motion.src} type="video/mp4" /></video><figcaption>{s.motion.label}</figcaption></figure></section> : null}

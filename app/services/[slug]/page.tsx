  ...
  return (
    <main className="sv-root">
      ...
      <section className="sv-hero">
        ...
        <div className="sv-hero-copy"><div className="sv-kicker">{s.motion ? "Motion / Film / Walkthrough" : "Visualization / Selected service"}</div><h1>{s.h1}</h1><p className="sv-tagline">{s.tagline}</p><p className="sv-lead">{s.intro}</p></div>
      ...
      <div className="sv-shell">
        ...
        <section className="sv-story">{s.sections.map((sec,index) => <article className="sv-story-row" key={sec.h}><div className="sv-story-no">0{index + 1}</div><h2>{sec.h}</h2><p>{sec.p}</p></article>)}</section>

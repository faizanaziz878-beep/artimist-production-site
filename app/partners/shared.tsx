...
export type Partner = { slug: string; name: string; kicker: string; ceo: string; initials: string; ceoTitle: string; accent: string; tagline: string; intro: string; body: Body[]; services: string[]; cta: string; visuals: PartnerVisual[] };
...
const VISUAL_CSS = `.ap-hub{max-width:1220px;padding-top:116px}.ap-hub-head{max-width:none;margin:0 0 64px;text-align:left;display:grid;grid-template-columns:1fr .8fr;gap:64px;align-items:end}.ap-hub-head h1{font-size:clamp(54px,7vw,92px);line-height:.96;letter-spacing:-.045em}.ap-hub-head p{font-size:18px;max-width:48ch;margin:0 0 8px}.ap-cards{max-width:none;gap:18px}.ap-card{padding:0;display:block;align-items:stretch;text-align:left;border:1px solid rgba(255,255,255,.1);background:#100e0f;overflow:hidden}.ap-card-top{margin:0;aspect-ratio:16/10;overflow:hidden;background:#e9e2d8}.ap-card-visual{width:100%;height:100%;display:block;object-fit:cover;transition:transform .6s ease}.ap-card:hover .ap-card-visual{transform:scale(1.02)}.ap-card-body{align-items:flex-start;padding:30px}.ap-card-body h3{font-size:38px}.ap-card-body p{max-width:52ch}.ap-wrap{max-width:1180px}.ap-detail-hero{display:grid;grid-template-columns:.9fr 1.1fr;gap:54px;align-items:center;padding:30px 0 70px}.ap-detail-hero h1{font-size:clamp(54px,7vw,92px);line-height:.96;letter-spacing:-.045em;margin:14px 0 18px}.ap-detail-hero .ap-tagline{margin:0}.ap-detail-lead{font-family:Georgia,serif;font-size:21px;line-height:1.56;color:#c9beba;margin:28px 0 0;max-width:58ch}.ap-detail-visual{position:relative;margin:0;border-radius:20px;overflow:hidden;border:1px solid rgba(255,255,255,.1);aspect-ratio:4/3;background:#e9e2d8}.ap-detail-visual img{width:100%;height:100%;object-fit:cover;display:block}.ap-detail-visual:after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,transparent 58%,rgba(9,8,9,.76))}.ap-detail-visual figcaption{position:absolute;z-index:1;left:16px;bottom:14px;color:#eee7e2;font-size:9px;letter-spacing:.13em;text-transform:uppercase}.ap-gallery{display:grid;grid-template-columns:1.2fr .8fr .8fr;gap:14px;padding-bottom:72px}.ap-gallery figure{position:relative;margin:0;border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,.1);aspect-ratio:4/3;background:#e9e2d8}.ap-gallery img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .55s ease}.ap-gallery figure:hover img{transform:scale(1.02)}.ap-gallery figcaption{position:absolute;left:12px;bottom:12px;padding:7px 10px;border-radius:999px;background:rgba(9,8,9,.82);font-size:9px;letter-spacing:.11em;text-transform:uppercase}.ap-ceo{display:grid;grid-template-columns:.45fr 1fr;align-items:center;text-align:left;padding:30px;border:1px solid rgba(255,255,255,.1);border-radius:16px;background:rgba(255,255,255,.022)}.ap-ceo-name{font-size:34px}.ap-body{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;padding:64px 0}.ap-sec{margin:0;padding:28px;border:1px solid rgba(255,255,255,.1);border-radius:16px;background:#100e0f}.ap-sec h4{font-size:27px}.ap-sec p{font-size:15px}.ap-chips-wrap{padding-top:44px}@media(max-width:860px){.ap-hub-head,.ap-detail-hero{grid-template-columns:1fr}.ap-gallery{grid-template-columns:1fr 1fr}.ap-gallery figure:first-child{grid-column:1/3;aspect-ratio:16/9}.ap-body{grid-template-columns:1fr}.ap-ceo{grid-template-columns:1fr;gap:10px}}@media(max-width:600px){.ap-hub{padding:92px 22px 130px}.ap-hub-head{gap:24px}.ap-hub-head h1,.ap-detail-hero h1{font-size:clamp(48px,14vw,66px)}.ap-wrap{padding:0 22px}.ap-detail-hero{padding-top:18px}.ap-detail-visual{aspect-ratio:1/1}.ap-gallery{grid-template-columns:1fr;padding-bottom:54px}.ap-gallery figure,.ap-gallery figure:first-child{grid-column:auto;aspect-ratio:4/3}.ap-card-body{padding:24px}.ap-cta-row{padding-bottom:140px}}`;
          ...
          {PARTNER_ORDER.map((slug) => {
            ...
            return (
              <Link className="ap-card" href={`/partners/${p.slug}`} key={p.slug}>
                <div className="ap-card-top"><img className="ap-card-visual" src={p.visuals[0].src} alt={p.visuals[0].alt} width="1200" height="750" loading="lazy" decoding="async" /></div>
    ...
    <main className="ap-root">
      ...
      <div className="ap-wrap">
        ...
        <div className="ap-ceo">
          <div className="ap-kicker">Leadership / accountable partner</div><div><div className="ap-ceo-name">{p.ceo}</div><div className="ap-ceo-title">{p.ceoTitle}, {p.name}</div></div>
        </div>

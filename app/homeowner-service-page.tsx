  ...
  return (
    <main className="hsp">
      ...
      <div className="hsp-wrap">
        ...
        <section className="hsp-hero"><div><div className="hsp-eyebrow">{props.eyebrow}</div><h1>{props.h1}</h1><div className="hsp-sub">{props.subtitle}</div><p className="hsp-intro">{props.intro}</p><p className="hsp-audience">{props.audience}</p><div className="hsp-actions"><Link className="hsp-btn hsp-primary" href="/contact">Get a project quote</Link><a className="hsp-btn hsp-secondary" href={WHATSAPP} target="_blank" rel="noreferrer">WhatsApp the studio</a></div></div><div className="hsp-hero-media"><img src={props.image} alt={props.imageAlt} /></div></section>

...
function visualsFor(slug: string): Visual[] {
  if (slug === "custom-house-design") return [
    { image: "/img/resext01.webp", alt: "Residential design project by Artimist Productions", caption: "Residential planning + design development" },
  ...
  if (slug === "3d-interior-design-service") return [
    { image: "/img/homeint01.webp", alt: "Photoreal residential interior project by Artimist Productions", caption: "Interior design + material direction" },
  ...
  if (slug === "plan-modification-service") return [
    { image: "/media/generated-architecture/artimist-architecture-053.webp", alt: "Existing and proposed apartment layout comparison", caption: "Layout comparison · Concept study" },
  ...
  return [
    { image: "/media/generated-architecture/artimist-architecture-012.webp", alt: "Backyard studio plan, elevations and section", caption: "Drawing package · Concept study" },
    { image: "/media/generated-architecture/artimist-architecture-088.webp", alt: "Section through a townhouse and rear addition", caption: "Extension section · Concept study" },
    { image: "/img/cad03.webp", alt: "Dimensioned residential ground-floor drawing", caption: "Clear residential plan information" },
  ];
}

function journeyFor(slug: string): Visual[] {
  if (slug === "custom-house-design") return [
    { image: "/media/generated-architecture/artimist-architecture-043.webp", alt: "Pencil-style townhouse floor plan concept", caption: "01 / Sketch intent · Concept study" },
    { image: "/img/cad03.webp", alt: "Custom house floor plan developed from the brief", caption: "02 / Floor plan" },
    { image: "/img/rhino02.webp", alt: "Three-dimensional house massing model", caption: "03 / Model + test" },
    { image: "/img/resext03.webp", alt: "Resolved custom house exterior visualization", caption: "04 / Final direction" },
  ];
  if (slug === "3d-interior-design-service") return [
    { image: "/img/homeint02.webp", alt: "Warm timber office interior used as a mood reference", caption: "01 / Brief + references" },
    { image: "/img/cad01.webp", alt: "Floor plan used to establish the interior layout", caption: "02 / Plan the room" },
    { image: "/img/max04.webp", alt: "Three-dimensional interior model in development", caption: "03 / Model + test" },
    { image: "/img/homeint03.webp", alt: "Resolved photoreal residential interior", caption: "04 / Final atmosphere" },
  ];
  if (slug === "plan-modification-service") return [
    { image: "/media/generated-architecture/artimist-architecture-087.webp", alt: "Existing-condition townhouse plan study", caption: "01 / Existing plan · Concept study" },
    { image: "/img/cad01.webp", alt: "Redrawn residential floor plan", caption: "02 / Redraw clearly" },
    { image: "/img/max04.webp", alt: "Three-dimensional room model used to test the change", caption: "03 / Test in 3D" },
    { image: "/img/resid02.webp", alt: "Residential design outcome after layout refinement", caption: "04 / Confirm direction" },
  ];
  return [
    { image: "/media/generated-architecture/artimist-architecture-021.webp", alt: "Coastal cottage exterior reference study", caption: "01 / Existing-home character · Concept study" },
    { image: "/media/generated-architecture/artimist-architecture-088.webp", alt: "Townhouse rear-extension section study", caption: "02 / Plan + document · Concept study" },
    { image: "/img/rhino02.webp", alt: "Three-dimensional renovation design model", caption: "03 / Model + review" },
    { image: "/img/services/plan-renovation-premium-2026.jpg", alt: "Resolved residential renovation and addition design", caption: "04 / Resolved design" },
  ];
}
...
const NEEDS: Related[] = [
  ...
  { href: "/sketch-to-floor-plan-service", label: "Turn my sketch into a plan" },
  { href: "/floor-plan-to-3d-rendering", label: "Turn my plan into 3D" },
];
...
export function HomeownerServicePage(props: HomeownerServicePageProps) {
  ...
  const journey = journeyFor(props.slug);
  const schema = {
  ...
  return (
    <main className="hsp">
      ...
      <style dangerouslySetInnerHTML={{ __html: CURATED_CSS }} />
      ...
      <div className="hsp-wrap">
        ...
        <section className="hsp-hero"><div><div className="hsp-eyebrow">{props.eyebrow}</div><h1>{props.h1}</h1><div className="hsp-sub">{props.subtitle}</div><details className="astra-scope"><summary>Scope & starting information</summary><p className="hsp-intro">{props.intro}</p><p className="hsp-audience">{props.audience}</p></details><div className="hsp-actions"><Link className="hsp-btn hsp-primary" href="/contact">Get a project quote</Link><a className="hsp-btn hsp-secondary" href={WHATSAPP} target="_blank" rel="noreferrer">WhatsApp the studio</a></div></div><figure className="hsp-hero-media"><img className="hsp-hero-proof" src={visuals[1].image} alt={visuals[1].alt} width="1200" height="1500" fetchPriority="high" decoding="async" /><figcaption className="hsp-hero-caption">Selected studio visuals / {props.serviceName}</figcaption><div className="hsp-hero-tech"><img src={props.image} alt={props.imageAlt} width="800" height="540" decoding="async" /><span>Drawing / design reference</span></div></figure></section>
        ...
        <section className="hsp-standard" aria-label="Commercial and delivery expectations"><p><strong>Clear before work starts.</strong> Quote, milestones, revisions and final formats are agreed in writing.</p><Link href="/legal">Read full client terms →</Link></section>
        ...
        <section className="hsp-journey" aria-labelledby={`hsp-journey-${props.slug}`}><header><div className="hsp-eyebrow">Transformation story</div><h2 id={`hsp-journey-${props.slug}`}>From what you have<br/>to what you need.</h2><p>Selected examples illustrate the route, not one project’s before-and-after. Concept studies are not construction documents. Swipe to explore 01–04.</p></header><div tabIndex={0} aria-label="Four-stage design sequence">{journey.map((v)=><figure key={v.caption}><img src={v.image} alt={v.alt} loading="lazy" decoding="async"/><figcaption>{v.caption}</figcaption></figure>)}</div></section>

...
function visualsFor(slug: string): Visual[] {
  ...
  if (slug === "plan-modification-service") return [
    { image: "/img/permit04.webp", alt: "Residential drawing sheet prepared by Artimist Productions", caption: "Existing information + coordinated revision" },
  ...
  return [
    { image: "/media/projects/permit-sets.webp", alt: "Residential permit drawing set prepared by Artimist Productions", caption: "Plans + elevations + technical coordination" },
  ...
  return (
    <main className="hsp">
      ...
      <div className="hsp-wrap">
        ...
        <section className="hsp-commercial" aria-label="Pricing, timeline, revisions and handover"><article><h3>Quote after review</h3><p>Fees follow a review of the available information, requested deliverables and deadline.</p></article><article><h3>Written schedule</h3><p>Review milestones, client inputs and final delivery are defined in the project scope.</p></article><article><h3>Controlled revisions</h3><p>The standard framework allows up to three reasonable revision rounds unless agreed otherwise.</p></article><article><h3>Defined handover</h3><p>PDF, DWG, RVT, model, image and editable-source delivery is listed before production.</p></article></section>

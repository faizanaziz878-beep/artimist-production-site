  ...
  return (
    <main className="hsp">
      ...
      <div className="hsp-wrap">
        ...
        <section className="hsp-sec">
          <div className="hsp-eyebrow">Project evidence</div><h2>See related Artimist work</h2>
          <div className="hsp-evidence">{evidence.map((item) => <Link key={item.href} href={item.href}><h3>{item.label}</h3><span>Open case study</span></Link>)}</div>
        </section>
        ...
        <section className="hsp-sec">
          ...
          <div className="hsp-related">{props.related.map((r) => <Link key={r.href} href={r.href}>{r.label}</Link>)}<Link href="/international">International Projects</Link><Link href="/case-studies">All Case Studies</Link></div>
        </section>

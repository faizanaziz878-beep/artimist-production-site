(function(){
  ...
  function init(){
    ...
    marquee.innerHTML='<div class="artimist-client-track">'+original+'</div>';
    var track=marquee.firstElementChild;

    var partners=section.querySelector('.st-partners');
    if(partners){partners.classList.add('artimist-partner-rail');var pc=partners.innerHTML;partners.innerHTML='<div class="artimist-partner-track">'+pc+'</div>';}
    ...
    var style=document.createElement('style');style.id='artimist-client-showcase-style';style.textContent=`
      ...
      .artimist-client-card{position:relative!important;min-width:0!important;width:auto!important;min-height:270px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:17px!important;padding:42px 28px!important;border-right:1px solid rgba(255,255,255,.12)!important;background:linear-gradient(145deg,rgba(255,255,255,.028),rgba(255,255,255,0))!important;color:#f3ede8!important;overflow:hidden!important}.artimist-client-card:before{content:attr(data-client-no);position:absolute;left:17px;top:17px;color:#cf5267;font:700 8px Arial,sans-serif;letter-spacing:.15em}.artimist-client-card:after{content:'';position:absolute;width:180px;height:180px;border-radius:50%;background:rgba(156,31,53,.12);filter:blur(55px);right:-80px;bottom:-90px;opacity:.45}.artimist-client-card img{max-width:54%!important;max-height:78px!important;width:auto!important;height:auto!important;object-fit:contain!important;filter:grayscale(1) brightness(1.42)!important;opacity:.92!important}.artimist-client-card strong,.artimist-client-card>b{max-width:90%;font:400 clamp(24px,2.4vw,36px)/1.05 Georgia,serif!important;letter-spacing:-.025em!important;text-align:center!important;color:#f2ece7!important;overflow-wrap:normal!important;word-break:normal!important;hyphens:none!important}.artimist-client-meta{position:absolute;left:17px;bottom:16px;color:rgba(255,255,255,.38);font:700 7px Arial,sans-serif;letter-spacing:.14em}
      .artimist-partner-rail{position:relative!important;z-index:2!important;width:100%!important;overflow:hidden!important;border-top:1px solid rgba(255,255,255,.08)!important;background:#080808!important}.artimist-partner-track{display:flex!important;align-items:center!important;gap:42px!important;width:max-content!important;min-width:100%!important;padding:19px 0!important;animation:artimistPartnerFlow 28s linear infinite!important;color:rgba(255,255,255,.46)!important;font:700 8px Arial,sans-serif!important;letter-spacing:.15em!important;white-space:nowrap!important}.artimist-partner-track>*{margin:0!important}.artimist-partner-track b{color:#fff!important}.artimist-partner-track span:last-child{color:#cf5267!important}@keyframes artimistPartnerFlow{from{transform:translate3d(-50%,0,0)}to{transform:translate3d(0,0,0)}}
      @media(max-width:1100px) and (min-width:761px){.artimist-client-track{grid-template-columns:repeat(3,minmax(0,1fr))!important}.artimist-client-card{min-height:250px!important}}@media(max-width:760px){.st-clients[data-artimist-clients="1"]{padding-top:78px!important}.artimist-client-intro{display:block!important;padding:26px 22px 38px!important}.artimist-client-intro h2{font-size:46px!important;margin:15px 0 16px!important}.artimist-client-intro>span{display:block!important;max-width:34ch!important;font-size:13px!important}.st-clients[data-artimist-clients="1"] .st-marquee{overflow-x:auto!important;scroll-snap-type:x mandatory!important;scrollbar-width:none!important}.st-clients[data-artimist-clients="1"] .st-marquee::-webkit-scrollbar{display:none!important}.artimist-client-track{display:flex!important;width:max-content!important;transform:none!important}.artimist-client-card{flex:0 0 78vw!important;width:78vw!important;min-height:310px!important;padding:34px 22px!important;scroll-snap-align:center!important}.artimist-client-card strong,.artimist-client-card>b{font-size:31px!important}.artimist-client-card img{max-width:58%!important;max-height:72px!important}.artimist-partner-track{animation-duration:20s!important;padding:15px 0!important;gap:30px!important}}
      @media(prefers-reduced-motion:reduce){.artimist-partner-track{animation:none!important}}
    `;document.head.appendChild(style);track.style.transform='none';return true;
  }

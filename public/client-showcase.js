(function(){
  ...
  function init(){
    ...
    if(!section||!marquee||section.dataset.artimistClients==='1')return false;
    ...
    /* Duplicate only after cards are enhanced so the loop is seamless. */
    ...
    style.textContent=`
      ...
      .artimist-client-intro>p{margin:0;color:#cf5267;font:700 9px/1 Arial,sans-serif;letter-spacing:.19em}
      .artimist-client-intro h2{margin:0;font:400 clamp(46px,5vw,88px)/.91 Georgia,serif;letter-spacing:-.045em}.artimist-client-intro h2 em{color:#e7b5bd;font-weight:400}
      .artimist-client-intro>span{color:rgba(255,255,255,.5);font:400 13px/1.65 Arial,sans-serif}
      .st-clients[data-artimist-clients="1"] .st-marquee{position:relative;z-index:2;overflow:hidden!important;border-top:1px solid rgba(255,255,255,.12);border-bottom:1px solid rgba(255,255,255,.12);padding:0!important}
      .st-clients[data-artimist-clients="1"] .st-marquee:before,.st-clients[data-artimist-clients="1"] .st-marquee:after{content:'';position:absolute;z-index:5;top:0;bottom:0;width:9vw;pointer-events:none}.st-clients[data-artimist-clients="1"] .st-marquee:before{left:0;background:linear-gradient(90deg,#0a0909,transparent)}.st-clients[data-artimist-clients="1"] .st-marquee:after{right:0;background:linear-gradient(-90deg,#0a0909,transparent)}
      #marquee[data-artimist-client-motion]{display:flex!important;width:max-content!important;min-width:200%!important;animation:artimistClientFlow 34s linear infinite!important;will-change:transform}
      #marquee[data-artimist-client-motion]:hover{animation-play-state:paused!important}
      ...
      .artimist-client-card:before{content:attr(data-client-no);position:absolute;left:17px;top:17px;color:#cf5267;font:700 8px Arial,sans-serif;letter-spacing:.15em}
      .artimist-client-card:after{content:'';position:absolute;width:180px;height:180px;border-radius:50%;background:rgba(156,31,53,.1);filter:blur(55px);right:-80px;bottom:-90px;opacity:0;transition:opacity .5s}
      .artimist-client-card:hover{background:rgba(255,255,255,.045)!important}.artimist-client-card:hover:after,.artimist-client-card.is-active:after{opacity:1}
      .artimist-client-card img{max-width:54%!important;max-height:78px!important;width:auto!important;height:auto!important;object-fit:contain!important;filter:grayscale(1) brightness(1.4)!important;opacity:.88!important;transition:filter .5s ease,opacity .5s ease,transform .55s cubic-bezier(.2,.75,.2,1)!important}.artimist-client-card:hover img,.artimist-client-card.is-active img{filter:grayscale(0) brightness(1.05)!important;opacity:1!important;transform:scale(1.035)!important}
      .artimist-client-card strong,.artimist-client-card>b{max-width:90%;font:400 clamp(24px,2.4vw,36px)/1.05 Georgia,serif!important;letter-spacing:-.025em!important;text-align:center!important;color:#f2ece7!important}.artimist-client-meta{position:absolute;left:17px;bottom:16px;color:rgba(255,255,255,.34);font:700 7px Arial,sans-serif;letter-spacing:.14em}
      ...
      @media(max-width:760px){
        .st-clients[data-artimist-clients="1"]{padding-top:82px!important}
        .artimist-client-intro{display:block!important;padding:28px 0 42px!important}.artimist-client-intro h2{font-size:48px!important;margin:16px 0 18px!important}.artimist-client-intro>span{display:block!important;max-width:34ch!important;font-size:13px!important}
        .st-clients[data-artimist-clients="1"] .st-kicker{font-size:9px!important;letter-spacing:.18em!important}
        .st-clients[data-artimist-clients="1"] .st-marquee{overflow:hidden!important}
        #marquee[data-artimist-client-motion]{animation-duration:22s!important}
        .artimist-client-card{flex-basis:76vw!important;min-height:285px!important;padding:36px 24px!important}
        .artimist-client-card strong,.artimist-client-card>b{font-size:32px!important}.artimist-client-card img{max-width:58%!important;max-height:72px!important}
        .artimist-client-card.is-active{background:rgba(255,255,255,.055)!important}
        .artimist-partner-track{animation-duration:27s!important;padding:17px 0!important;gap:30px!important}
      }

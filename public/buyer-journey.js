(function(){
  ...
  var items=[
    ['01','Design my house','Custom plans and a home layout built around your site and life.','/custom-house-design','/img/services/design-house-premium-2026.jpg',1536,1024],
    ['02','Design my interior','Rooms, materials, furniture and realistic 3D views before you build.','/3d-interior-design-service','/img/services/design-interior-premium-2026.jpg',1536,1024],
    ['03','Change my floor plan','Modify an existing plan, redraw a sketch or improve a layout without starting over.','/plan-modification-service','/img/services/change-floor-plan-premium-2026.jpg',1536,1024],
    ['04','Plan my renovation','Remodel, addition, extension and permit-drawing support.','/residential-renovation-permit-drawings','/img/services/plan-renovation-premium-2026.jpg',1536,1024],
    ['05','Show me the design in 3D','Photoreal rendering for houses, interiors, developments and ideas.','/visualization','/img/resid01.webp',1672,941],
    ['06','Prepare clean drawings','Floor plans, elevations, CAD, Revit and professional production support.','/architectural-drafting-services','/img/permit01.webp',1448,1086]
  ];
  ...
  function buildBuyerJourney(){
    ...
    var cards=items.map(function(x){return '<a class="artimist-need" href="'+esc(x[3])+'"><img src="'+esc(x[4])+'" alt="'+esc(x[1])+'" width="'+x[5]+'" height="'+x[6]+'" loading="lazy" decoding="async"><article><small>'+x[0]+' / COMMON REQUEST</small><h3>'+esc(x[1])+'</h3><p>'+esc(x[2])+'</p></article></a>';}).join('');

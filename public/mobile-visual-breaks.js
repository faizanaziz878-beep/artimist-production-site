(function(){
  ...
  var sets={
    ...
    '/services':[
      ['/graphics/custom-house-floor-plan-design.svg','Custom house design and floor planning','HOUSE DESIGN'],
      ['/graphics/3d-interior-design-visualization.svg','3D interior design visualization','INTERIOR + 3D']
    ]
  };
  if(!sets[path])return;
  ...
  function build(){
    ...
    sets[path].forEach(function(v){var f=document.createElement('figure');f.innerHTML='<img src="'+v[0]+'" alt="'+v[1]+'" loading="lazy"><figcaption>'+v[2]+'</figcaption>';wrap.appendChild(f);});

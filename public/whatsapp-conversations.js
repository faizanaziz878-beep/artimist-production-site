(function () {
  ...
  function makeHref(source) {
    ...
    var text = 'Hi Artimist Productions — I’m interested in ' + topic + ' and would like to discuss a project.';
  ...
  function wireConversationLinks(root) {
    ...
    Array.prototype.forEach.call(links, function (a) {
      if (!isConversationLink(a)) return;
      if (a.dataset.artimistWhatsapp === '1') return;
  ...
  function addPersistentCta() {
    ...
    a.className = 'artimist-whatsapp';
    a.href = makeHref('the website');
    a.target = '_blank';
    a.rel = 'noopener noreferrer';
    a.setAttribute('aria-label', 'Talk to Artimist Productions on WhatsApp');
    ...
    a.addEventListener('click', function () { track('persistent_whatsapp'); });
